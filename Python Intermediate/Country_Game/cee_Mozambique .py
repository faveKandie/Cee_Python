#This is the main program for the cee_Mozambique game
import turtle
import time
import pandas
...
rate = turtle.Screen()
rate.title("cee_Mozambique")

doc = pandas.read_csv("Mozambique_states.csv")
listdoc = doc["states"].to_list()

Mozambique_img = "Mozambiqueee.gif"
rate.addshape(Mozambique_img)
rate.setup(800, 710)
turtle.shape(Mozambique_img)
rate.tracer(100)
...
timer.write(f"00:{Time}", align = "center", font = ("ComicSans MS", 20, "bold"))   
...
def func():
    ...
    elif state_text == "Exit" or score == 10:
        pass
...
while len(guessed_state) != 11:
    ...
    if state_text in listdoc and state_text not in guessed_state:
        ...
        scoree.clear()
        scoree.write(f"{score}/10", align = "center", font = ("ComicSans MS", 20, "bold"))
    if  score == 10:
        time.sleep(1)
        rate.clear()
        rate.bgcolor("black")
