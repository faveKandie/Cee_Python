#This is the main program for cee Zimbabwe game
import turtle
import time
import pandas
...
rate = turtle.Screen()
rate.title("cee_Zimbabwe")

doc = pandas.read_csv("Zimbabwe.csv")
listdoc = doc["states"].to_list()

Zimbabwe_img = "Zimbabweee.gif"
rate.addshape(Zimbabwe_img)
rate.setup(800, 710)
turtle.shape(Zimbabwe_img)
rate.tracer(100)
