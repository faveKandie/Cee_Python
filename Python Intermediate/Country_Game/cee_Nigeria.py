#This is the main program for the cee_Nigeria Game
import turtle
import time
import pandas
...
rate = turtle.Screen()
rate.title("cee_Nigeria")

doc = pandas.read_csv("50_states.csv")
listdoc = doc["states"].to_list()

nigeria_img = "Nigeria.gif"
rate.addshape(nigeria_img)
rate.setup(800, 710)
turtle.shape(nigeria_img)
rate.tracer(100)
...
timer.write(f"02:00", align = "center", font = ("ComicSans MS", 20, "bold"))   
...
def func():
    ...
    if  Time > 0 :
        ...
        for m in rare:
            ...
            writer.pendown()
            writer.write(f"{m}", align = "center", font = ("ComicSans MS", 10, "bold"))
        time.sleep(5)
        rate.clear()
        rate.bgcolor("black")
        writer.penup()
    ...
    elif state_text == "Exit"  or score == 37:
        pass
...
while len(guessed_state) != 38:
    ...
    if state_text in listdoc and state_text not in guessed_state:
        ...
        writer.pendown()
        writer.write(f"{state_text}", align = "center", font = ("ComicSans MS", 10, "bold"))
        scoree.clear()
        scoree.write(f"{score}/37", align = "center", font = ("ComicSans MS", 20, "bold"))
    if  score == 37:
        time.sleep(1)
        rate.clear()
        rate.bgcolor("black")
